...
ALL CODE SOURCED FROM: https://github.com/kokke/tiny-AES-c/tree/master
...
int main(void)
{
    ...
    own_printf("\nTesting AES128\n\n");
#else
    own_printf("You need to specify a symbol between AES128, AES192 or AES256. Exiting");
    return 0;
#endif
...
static void test_encrypt_ecb_verbose(void)
{
    ...
    own_printf("ECB encrypt verbose:\n\n");
    own_printf("plain text:\n");
